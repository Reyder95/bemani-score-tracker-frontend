...
class UserGoalsFilters extends React.Component {
    render() {
        return (
          <div className="componentUserGoalsFilters mb-5 border border-secondary rounded p-3">
            <form>
...
export default UserGoalsFilters;